<?php
/*
Plugin Name:HQ Sand Box
Plugin URI: http://www.houseofquorum.com
Description:Trasfer data between test website and live website
Version: 1.0
License: GPLv2
Author:David Kayo & Robin Kumar Paul
...
function sandbox_admin_menu() {
    add_menu_page('Sand Box', 'Sand Box', 'administrator',
'Sand Box', 'sandbox_html_page');
}
}
?>
...
<tr>
    <td><b>Current Development Theme is</b>:
...
<select name="dev_site" id="dev_site">
 ...
 ?> 
        ...
        <a href=" <?php bloginfo(siteurl); echo"/?dev"?>" target="_blank"> Click Here </a> to see developing theme
        </td>
        </tr>
</table>
